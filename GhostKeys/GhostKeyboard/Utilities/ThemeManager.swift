    ...
    static func theme(for style: UIUserInterfaceStyle) -> KeyboardTheme {
        if style == .dark {
            return KeyboardTheme(
                ...
                suggestionBarBackground: UIColor(red: 0.11, green: 0.11, blue: 0.12, alpha: 0.9),
                keyboardBackground: UIColor(red: 0.11, green: 0.11, blue: 0.12, alpha: 1.0),
                keyShadowColor: UIColor.black.withAlphaComponent(0.4),
                popupBackground: UIColor(red: 0.29, green: 0.29, blue: 0.30, alpha: 1.0),
            ...
            return KeyboardTheme(
                ...
                suggestionBarBackground: UIColor(red: 0.95, green: 0.95, blue: 0.97, alpha: 1.0),
                keyboardBackground: UIColor(red: 0.82, green: 0.83, blue: 0.86, alpha: 1.0),
